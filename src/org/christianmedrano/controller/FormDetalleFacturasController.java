...
import org.christianmedrano.model.Factura;
    ...
    public ObservableList<Producto> listarProductos(){
        ...
        try{
            ...
            while(resultSet.next()){
                ...
                int cantidadStack = resultSet.getInt("cantidadStack");
                ...
                productos.add(new Producto(productoId, nombreProducto, descripcionProducto, cantidadStack, precioVentaUnitario, precioVentaMayor,precioCompra,imagenProducto,distribuidor,categoria));
            }
        }catch(SQLException e){
            System.out.println(e.getMessage());
        }finally{
