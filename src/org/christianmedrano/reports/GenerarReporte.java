 ...
 */
package org.christianmedrano.reports;
...
public class GenerarReporte {
    ...
    public void generarFactura(int factId){
        try{
            ...
            JasperPrint reporte = JasperFillManager.fillReport(GenerarReporte.class.getResourceAsStream("/org/christianmedrano/reports/Factura.jasper"), parametros, conexion);
